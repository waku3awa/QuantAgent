...
def process_single_ticker(
    ...
    Args:
        ...
        provider: LLM provider ("openai", "claude_api", "claude_cli", "ollama", "openai_compatible")
...
Supported providers: openai (default), claude_api, claude_cli, ollama, openai_compatible
        """
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="openai",
        choices=["openai", "claude_api", "claude_cli", "ollama", "openai_compatible"],
