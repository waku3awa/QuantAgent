...
def create_trend_agent(tool_llm, graph_llm, toolkit, config=None):
    """
    ...
    def trend_agent_node(state):
        ...
        # --- 設定ベースでプロンプトを取得 ---
        system_prompt = provider.get_prompt("trend_agent", "system")
        ...
        if trend_image_b64:
            ...
            image_system_prompt = provider.get_prompt("trend_agent", "image_system")
